      ...
      <nav className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="container flex items-center justify-between py-6">
          ...
          <div className="hidden md:flex gap-8 items-center">
            ...
            <a href="#founder" className="text-sm hover:text-primary transition-colors">Founder</a>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-lg text-foreground/80 leading-relaxed max-w-md">
                W-ONE STUDIO คือสตูดิโอที่ปรึกษาและออกแบบกลยุทธ์ธุรกิจสำหรับฟรีแลนซ์และผู้ประกอบการยุคใหม่ที่ไม่อยากใช้ชีวิตไปกับเส้นทางเดิม ๆ
              </p>
              
              <p className="text-base text-foreground/70">
                เราช่วยให้คุณออกแบบชีวิตในแบบของตัวเอง และเลือกสนามที่เหมาะกับตัวเองที่สุด
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 lg:order-1">
              ...
              <blockquote className="text-xl text-foreground/90 italic border-l-4 border-primary pl-6 py-4">
                "ผมไม่ชอบแข่งขันในเกมของใคร ถ้าโลกนี้คือกระดานหมากรุก ผมจะเลือกเป็นคนออกแบบเกม ไม่ใช่แค่หมากในกระดาน"
              </blockquote>
              
              <div className="space-y-4">
                <p className="text-foreground/80 leading-relaxed">
                  เราเชื่อในพลังของความแตกต่าง เอกลักษณ์ที่ไม่ต้องเหมือนใคร และการเติบโตที่เริ่มจากการเข้าใจตัวเองอย่างลึกซึ้ง
                </p>
                <p className="text-foreground/80 leading-relaxed">
                  เพราะเส้นทางที่คุณสร้างเอง จะเป็นเส้นทางที่พาคุณไปได้ไกลกว่าที่คิด
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <h2 className="text-4xl font-bold mb-6">W-ONE STUDIO เหมาะกับใคร</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="p-8 border border-border rounded-lg hover:border-primary/50 transition-colors">
              ...
              {[
                {
                  id: "academy",
                  title: "W-ONE Academy",
                  description: "คอร์สออนไลน์ หนังสือ และ E-book ที่ช่วยจัดระเบียบความคิด วางโครงสร้างธุรกิจ และสร้างแบรนด์ที่สะท้อนตัวตนจริง"
                },
                {
                  id: "coaching",
                  title: "Personal Coaching",
                  description: "การให้คำปรึกษาแบบตัวต่อตัว เพื่อช่วยคุณมองเห็นศักยภาพที่ซ่อนอยู่ และออกแบบทิศทางชีวิต-ธุรกิจที่ใช่สำหรับคุณ"
                },
                {
                  id: "branding",
                  title: "Brand Design Studio",
                  description: "บริการออกแบบอัตลักษณ์แบรนด์ และวางกลยุทธ์การตลาดแบบครบวงจร ตั้งแต่แก่นความคิด ไปจนถึงการสื่อสารที่ทรงพลัง"
                }
              ].map((service) => (
                <div 
                  key={service.id}
          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-8">
              ...
              <p className="text-lg text-foreground/80 leading-relaxed">
                ที่ W-ONE STUDIO เราไม่ได้ให้แค่ความรู้หรือเครื่องมือ แต่เรามอบ <span className="font-semibold">ความชัด ความมั่นใจ และอำนาจในการตัดสินใจ</span>
              </p>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <blockquote className="text-lg text-foreground/90 italic border-l-4 border-primary pl-6 py-4">
                    "คนเราไม่จำเป็นต้องเดินตามเส้นทางที่โลกขีดไว้ ถ้าเรากล้าสร้างเส้นทางของตัวเอง"
                  </blockquote>
                  
                  <p className="text-foreground/80 leading-relaxed">
                    จากประสบการณ์และองค์ความรู้ระดับโลก เรานำศาสตร์จาก IBM, University of London, Google และ CalArts มาหลอมรวมเป็นระบบคิดที่ช่วยให้ฟรีแลนซ์ก้าวข้ามคำว่า "รับจ้าง" และเติบโตเป็น ผู้ประกอบการเดี่ยว (Solopreneur) อย่างแท้จริง
                  </p>
                </div>
              </div>
              
              <div className="border-t border-border pt-6">
                <p className="text-sm font-semibold text-primary mb-4">Certified by</p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-foreground/70">Design the Game, Don't Just Play It</p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-foreground/70">
                ...
                <li><a href="#" className="hover:text-primary transition-colors">Brand Design</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-foreground/70">
                ...
                <li><a href="#" className="hover:text-primary transition-colors">Founder</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-foreground/70">
                <li><a href="mailto:hello@w-one.studio" className="hover:text-primary transition-colors">Email</a></li>
